...
from llm_basics.cs336_basics.layer import TransformerBlock, RMSNorm, Linear, Embedding, scaled_dot_product_attention
import logging
...
class TransformerBlockWithHFRope(nn.Module):
    ...
    def __init__(self, d_model: int, num_heads: int, num_kv_heads: int, d_ff: int, 
        ...
        from llm_basics.cs336_basics.layer import SwiGLU
